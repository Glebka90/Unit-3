// Task 1
// При нажатии кнопки .b-1 срабатывает функция f1. Функция должна прочитать содержимое 
// .i-1 и сравнить его с числом 4 (сравнение ==).
...
// Есть кнопка b-5 которая запускает функцию f5. Функция должна вывести в .out-5 символ
// 'm' если число меньше нуля, 0 если число равно нулю и число 1 если больше.
...
//  При нажатии кнопки .b-7 срабатывает функция f7. Функция должна число из 
//  .i-71 возвести в степень .i-72, вывести результат в  .out-7. Для возведения 
//  в степень можно использовать **, или Math.pow.
...
function f8() {
   ...
   switch (s_8) {
      case 1:
         out_8.textContent = 'one';
         break;
      case 2:
         out_8.textContent = 'two';
         break;
      case 3:
         out_8.textContent = 'three';
         break;
      default:
         out_8.textContent = 'non';
   }
}
